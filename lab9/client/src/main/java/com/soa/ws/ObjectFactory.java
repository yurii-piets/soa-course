...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://ws.soa.com/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://ws.soa.com/", "helloWorldResponse");
     ...
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link HelloWorld_Type }{@code >}
     */
    @XmlElementDecl(namespace = "http://ws.soa.com/", name = "helloWorld")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.soa.com/", name = "helloWorldResponse")
